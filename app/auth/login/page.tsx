    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          {/* Demo credentials */}
          <div className="bg-blue-50 rounded-xl p-3 mb-6 text-xs text-blue-700 space-y-1">
            <p className="font-semibold">Demo Accounts:</p>
            <p>Super Admin: superadmin@example.com / SuperAdmin123</p>
            <p>Admin: admin@example.com / Admin123456</p>
            <p>User: user@example.com / User123456</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/register" className="text-blue-600 font-semibold hover:underline">Create account</Link>
          </p>
        </div>
      </div>
    </div>
